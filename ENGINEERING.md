...
> **注意**：本文档主要记录了 **v0.1.0 阶段**（2025年1月）从基础脚本项目到成熟开源项目的首次工程化过程。**v0.2.0 及之后的架构重构、多模型支持、CLI 体验增强与核心机制深化**等改进，请查阅 [`docs/IMPLEMENTATION_SUMMARY.md`](docs/IMPLEMENTATION_SUMMARY.md)。
